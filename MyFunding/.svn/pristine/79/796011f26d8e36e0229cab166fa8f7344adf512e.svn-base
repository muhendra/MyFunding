(function () {
    window.app.factory('PencadanganService', PencadanganService);

    PencadanganService.$inject = ['$http', 'DataService', 'alerts'];
    function PencadanganService($http, DataService, alerts) {

        var controllerPath = 'Pencadangan/'
        var list = [];
