(function () {
    window.app.factory('jabatanService', jabatanService);

    jabatanService.$inject = ['$http', 'DataService', 'alerts'];
    function jabatanService($http, DataService, alerts) {

        var controllerPath = 'Jabatan/'
        var list = [];        
