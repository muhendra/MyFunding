...
.directive('timepickerPop', function ($document, timepickerState) {
    return {
        ...
        template: "<input type='text' class='form-control' ng-model='inputTime' ng-change='ngChange' ng-blur='ngBlur' ng-disabled='disabledInt' time-format show-meridian='showMeridian' ng-focus='open()' />"
