(function () {
    ...
    window.app.controller('HistoryReceiveController', HistoryReceiveController);

    HistoryReceiveController.$inject = ['$scope', '$modal', 'PurchasereceiveService', 'branchService', 'alerts'];
    function HistoryReceiveController($scope, $modal, PurchasereceiveService, branchService, alerts) {
        var vm = this;
        vm.search = search;
        //vm.add = add;
        vm.detail = detail;
        ...
        //vm.historypurchasereceiveGetPage = PurchasereceiveService.HistoryGetPage;
        vm.historyPurchaseReceiveGetAll = PurchasereceiveService.HistoryGetAll;
