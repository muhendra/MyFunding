(function () {
    ...
    window.app.directive('addPurchaserequest', addPurchaserequest);

    function addPurchaserequest() {
        return {
            templateUrl: MyApplication.rootPath + '/purchaserequest/template/add.tmpl.cshtml',
    ...
    function controller($scope, $modal, Upload, $timeout, PurchaserequestService, EnquirytabunganService) {
        ...
        vm.purchaserequest.prDate = new Date();

        PurchaserequestService.getNoPurchase()
        .then(function (value) {
            vm.purchaserequest.prId = value;
        });
        ...
        vm.detailBarangTableActions = {
            ...
            editDetailBarang: editDetailBarang
        };
        ...
        function editDetailBarang(data) {
            var modalInstance = $modal.open({
                windowClass: 'form-modal-window-600',
                template: '<edit-Detailbarang data="data" />',
        ...
        //    var modalInstance = $modal.open({
        //        //windowClass: 'form-modal-window-800',765
        //        backdrop: 'static',
        //        template: '<add-detailbarang />'
        //    });

        //    modalInstance.finally.then(function (detailBarang) {
