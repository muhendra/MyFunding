(function () {
    ...
    window.app.directive('detailsCashback', detailsCashback);

    function detailsCashback() {
        return {
            templateUrl: MyApplication.rootPath + '/cashback/template/historydetail.tmpl.cshtml',
