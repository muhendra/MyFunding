(function () {
    ...
    function controller($scope, $modal, Upload, $timeout, EnquirytabunganService) {
        ...
        vm.enquirytabungan.attachmentPenyimpangan;
        //20200710, Eka, END
        ...
        function Download2(data) {
            var fileURL = MyApplication.rootPath + 'Files\\enquirytabungan\\Temp\\' + data.attachmentPenyimpangan;
            var a = document.createElement('a');
            a.href = fileURL;
            a.target = '_blank';
            a.download = data.attachmentPenyimpangan;
            document.body.appendChild(a);
            a.click();
        }
        //20200710, Eka, END
        ...
        function save() {
            ...
            else if (vm.enquirytabungan.detailUploadList == null) {
                alert('Upload SP Nasabah tidak boleh kosong.');
                return false;
            }
            //20200710, Eka, BEGIN
            else if (vm.enquirytabungan.penyimpanganProgram == "Ya" && vm.enquirytabungan.attachmentPenyimpangan == null) {
                alert('Attachment Penyimpangan tidak boleh kosong.');
                return false;
            }
            //20200710, Eka, END

            vm.saving = true;
            EnquirytabunganService.add(vm.enquirytabungan, vm.enquirytabungan.detailUploadList, vm.enquirytabungan.attachmentPenyimpangan)
                    .then(function (data) {
