(function() {
	...
	window.app.controller('AuthorizeenquirytabunganController', AuthorizeenquirytabunganController);

	AuthorizeenquirytabunganController.$inject = ['$scope', '$modal', 'EnquirytabunganService', 'branchService', 'alerts'];
	function AuthorizeenquirytabunganController($scope, $modal, EnquirytabunganService, branchService, alerts) {
	    var vm = this;
	    vm.search = search;
	    vm.add = add;
	    vm.reject = reject;
		...
		vm.authorizeEnquiryGetAll = EnquirytabunganService.AuthorizeGetAll;
		...
		EnquirytabunganService.getBranchUserLogin().then(function (value) {
		    ...
		    vm.authorizepaymentrequestGetPage = EnquirytabunganService.authorizegetPage;
