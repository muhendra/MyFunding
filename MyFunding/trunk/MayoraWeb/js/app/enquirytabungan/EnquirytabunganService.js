(function () {
    ...
    function EnquirytabunganService($http, DataService, alerts) {
        ...
        var svc = {
            ...
            //20200710, eka, BEGIN
            GetAll: GetAll,
            AuthorizeGetAll: AuthorizeGetAll,
            RejectGetAll: RejectGetAll,
            GetDetailBarangKatalog: GetDetailBarangKatalog,
            //20200710, eka, BEGIN
        };
        ...
        function AuthorizeGetAll(params) {
            return DataService.post(controllerPath + 'AuthorizeGetAll', params)
				.then(function (response) {
				    return response;
				});
        }

        function RejectGetAll(params) {
            return DataService.post(controllerPath + 'RejectGetAll', params)
				.then(function (response) {
				    return response;
				});
        }

        function GetDetailBarangKatalog(params) {
            return DataService.post(controllerPath + 'GetDetailBarangKatalog', params)
				.then(function (response) {
				    return response;
				});
        }
