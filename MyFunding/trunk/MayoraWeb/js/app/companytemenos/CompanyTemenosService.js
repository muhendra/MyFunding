(function () {
    window.app.factory('companyTemenosService', companyTemenosService);

    companyTemenosService.$inject = ['$http', 'DataService', 'alerts'];
    function companyTemenosService($http, DataService, alerts) {

        var controllerPath = 'CompanyTemenos/'
        var list = [];               
