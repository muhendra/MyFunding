(function() {
	...
	function PaymentrequestController($scope, $modal, PaymentrequestService, branchService, alerts) {
		...
		PaymentrequestService.getBranchUserLogin().then(function (value) {
		    vm.paymentrequest.cabang = value.branchCodeT24;
		    vm.paymentrequest.requester = value.userFullName;
		    if (value.isKpno == 'no') {
