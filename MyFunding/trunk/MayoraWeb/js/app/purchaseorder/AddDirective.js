    ...
    function controller($scope, $modal, Upload, $timeout, PurchaseorderService, employeeService, departmentService, PurchaserequestService, EnquirytabunganService) {
        ...
        vm.onSelectSupplier = function () {
            ...
            if (vm.selectedSupplier != null) {
                ...
                //20200708, eka, BEGIN
                vm.selectedBank = { bankName: vm.selectedSupplier.nm_Bank };
                vm.purchaseorder.namaBank = vm.selectedSupplier.nm_Bank;
                vm.purchaseorder.nomorRekeningVendor = vm.selectedSupplier.noRek;
                //20200708, eka, END
            }
            else {
