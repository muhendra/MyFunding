    ...
    angular.module('fcsa-number', []).directive('fcsaNumber', function () {
        ...
        return {
            ...
            link: function (scope, elem, attrs, ngModelCtrl) {
                var isValid, options;
                options = { preventInvalidInput: true };
                ...
                if (scope.maxDecimals !== undefined) {
                    options.maxDecimals = scope.maxDecimals;
                }
                if (scope.maxDigits !== undefined) {
                    options.maxDigits = scope.maxDigits;
                }
                if (scope.append !== undefined) {
                    options.append = scope.append;
                }
                if (scope.prepend !== undefined) {
                    options.prepend = scope.prepend;
                }
