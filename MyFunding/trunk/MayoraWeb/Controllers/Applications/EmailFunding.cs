...
namespace MyWeb.Controllers.Applications
{
    public class EmailFunding
    {
        ...
        public List<string> blind_copy_recipients { get; set; }
        public List<string> copy_recipients { get; set; }
        ...
        public EmailFunding(string recipient, string subject, string body)
        {
            this.recipients = new List<string>();
            this.copy_recipients = new List<string>();
            this.blind_copy_recipients = new List<string>();
        ...
        public EmailFunding(List<string> recipients, string subject, string body)
        {
            this.recipients = new List<string>();
            this.copy_recipients = new List<string>();
            this.blind_copy_recipients = new List<string>();
