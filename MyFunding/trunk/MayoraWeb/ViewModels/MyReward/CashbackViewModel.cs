...
{
    public class CashbackViewModel : IMapFrom<PurchaseOrder>, IHaveCustomMappings
	{
        ...
        {
            configuration.CreateMap<CashbackViewModel, PurchaseOrder>();
                //.ForAllMembers(opt => opt.Condition(srs => !srs.IsSourceValueNull)); 
            configuration.CreateMap<PurchaseOrder, CashbackViewModel>()
