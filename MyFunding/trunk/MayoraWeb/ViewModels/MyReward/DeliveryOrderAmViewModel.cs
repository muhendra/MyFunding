...
{
    public class DeliveryOrderAmViewModel : IMapFrom<DeliveryOrder>, IHaveCustomMappings
	{
        ...
        {
            configuration.CreateMap<DeliveryOrderAmViewModel, DeliveryOrder>();
                //.ForAllMembers(opt => opt.Condition(srs => !srs.IsSourceValueNull)); 

            configuration.CreateMap<DeliveryOrder, DeliveryOrderAmViewModel>()
