(function () {
    window.app.factory('departmentService', departmentService);

    departmentService.$inject = ['$http', 'DataService', 'alerts'];
    function departmentService($http, DataService, alerts) {

        var controllerPath = 'Department/'
        var list = [];        
