        ...
        function () {
            ...
            if (vm.selectedPurchaseOrder != null) {
                ...
                PurchaseorderService.historyGetPage({ no: vm.selectedPurchaseOrder.poId, jenistabungan: 'TabunganSiPucukReward', cabang: '' }).then(function (data) {
                    ...
                    //vm.amortisasirequest.pR_ApproveBy2 = data.data[0].approveBy2;
                    //vm.amortisasirequest.pR_ApproveDate2 = data.data[0].approveDate2;
                    //vm.amortisasirequest.pR_StatusData2 = data.data[0].statusData2;
                    
                    vm.setKartuAmortisasi();

                })

                //vm.amortisasirequest.dOid = vm.selectedPurchaseOrder.id;
                //vm.amortisasirequest.do_PurchaseOrderId = vm.selectedPurchaseOrder.purchaseOrderId;
                //vm.amortisasirequest.do_DeliveryOrderId = vm.selectedPurchaseOrder.deliveryOrderId;
                //vm.amortisasirequest.do_DeliveryOrderDate = vm.selectedPurchaseOrder.deliveryOrderDate;
                //vm.amortisasirequest.do_StatusBarang = vm.selectedPurchaseOrder.statusBarang;
                //vm.amortisasirequest.do_Receiver = vm.selectedPurchaseOrder.receiver;
                //vm.amortisasirequest.do_Condition = vm.selectedPurchaseOrder.condition;
                //vm.amortisasirequest.do_attachmentTandaTerima = vm.selectedPurchaseOrder.attachmentTandaTerima;
                //vm.amortisasirequest.do_Description = vm.selectedPurchaseOrder.description;
